...
[Python SDK](https://github.com/FlowiseAI/FlowisePy) 可用于创建 [Streamlit](https://streamlit.io/) 应用：
...
完整的 Github 存储库：[https://github.com/HenryHengZJ/flowise-streamlit](https://github.com/HenryHengZJ/flowise-streamlit)
